...
grep -q '/.local/bin/fr-bridge'           "$H1/.crontab" || { echo "case1: bridge line missing"; exit 1; }
...
grep -q '/.local/bin/fr-bridge'                   "$H2/.crontab" || { echo "case2: fresh managed bridge line missing"; exit 1; }
